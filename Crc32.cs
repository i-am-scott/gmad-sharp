namespace umad
{
    public static class Crc32
    {
        ...
        public static uint Compute(ulong value, uint CrcSeed = 0xFFFFFFFF)
        {
            uint crc = 0;
            crc ^= CrcSeed;
        ...
        public static uint Compute(byte[] buffer, uint CrcSeed = 0xFFFFFFFF)
        {
            return Compute(buffer, 0, buffer.Length);
        }

        public static uint Compute(byte[] buffer, int offset, int length, uint CrcSeed = 0xFFFFFFFF)
        {
            if (buffer == null)
            {
